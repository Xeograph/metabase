  ...
  (u/step "Compile Clojure source files"
    (let [paths    (all-paths basis)
      ...
      (with-duration-ms [duration-ms]
        ...
        ;; and store them in a file 'namespaces.txt' in the uberjar. At runtime,
        ;; this file will be used to run the tests.
        (b/write-file { :path (str class-dir "/namespaces.txt")
